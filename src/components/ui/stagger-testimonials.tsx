...
export const StaggerTestimonials: React.FC = () => {
  ...
  return (
    <div className="relative w-full overflow-x-hidden bg-muted/30  sm:py-20 mt-0 px-4">
      <div className="text-center mb-6">
        <h2 className="text-3xl sm:text-5xl font-semibold text-zinc-800 font-serif">
          Happy Clients. Beautiful Designs.
        </h2>
        <p className="text-lg sm:text-xl text-zinc-600 mt-3 max-w-2xl mx-auto">
          Our customers love our professional virtual interior design services and here is why.
        </p>
      </div>
      <div className="relative w-full flex justify-center flex-wrap items-center min-h-[500px]">
